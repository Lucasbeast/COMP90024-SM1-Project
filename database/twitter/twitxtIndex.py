...
def create_twitter_index():
    ...
    client = Elasticsearch(
        ...
        request_timeout=30  # Increase the timeout value
    )
    ...
    # Create the index
    try:
        client.indices.create(index='twitter-word', body=index_body)
        print("Index 'twitter-word' created successfully.")
    except RequestError as e:
        if e.error == 'resource_already_exists_exception':
            print("Index 'twitter-word' already exists.")
        else:
            raise
